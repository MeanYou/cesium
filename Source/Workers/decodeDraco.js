...
define(['./ComponentDatatype-579b2047', './when-6655f883', './IndexDatatype-e7458bc9', './RuntimeError-5f205b85', './createTaskProcessorWorker', './WebGLConstants-cf1206a6'], (function (ComponentDatatype, when, IndexDatatype, RuntimeError, createTaskProcessorWorker, WebGLConstants) { 'use strict';

...
define(['./Matrix2-08e4fdf4', './AxisAlignedBoundingBox-2581d499', './Transforms-e93813e8', './when-6655f883', './RuntimeError-5f205b85', './TerrainEncoding-ca70767a', './ComponentDatatype-579b2047', './OrientedBoundingBox-926398d5', './WebMercatorProjection-40d158aa', './createTaskProcessorWorker', './combine-1fd4d5cd', './AttributeCompression-f0abb793', './WebGLConstants-cf1206a6', './EllipsoidTangentPlane-7ac45df7', './IntersectionTests-bc616cc3', './Plane-8bcfd1cf'], (function (Matrix2, AxisAlignedBoundingBox, Transforms, when, RuntimeError, TerrainEncoding, ComponentDatatype, OrientedBoundingBox, WebMercatorProjection, createTaskProcessorWorker, combine, AttributeCompression, WebGLConstants, EllipsoidTangentPlane, IntersectionTests, Plane) { 'use strict';

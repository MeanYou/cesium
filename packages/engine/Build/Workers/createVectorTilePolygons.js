define(['./AttributeCompression-ec6d27e6', './Matrix3-51afcfcb', './Color-c4613068', './defaultValue-040c41f9', './IndexDatatype-086e75a1', './Math-f7bd710c', './OrientedBoundingBox-bdd2e487', './Matrix2-3a8613cf', './createTaskProcessorWorker', './ComponentDatatype-614bb7b9', './Check-e01dbea3', './WebGLConstants-f7267ced', './Transforms-dd1e4b9a', './combine-6eb6e848', './RuntimeError-3c5db370', './EllipsoidTangentPlane-b1f9214c', './AxisAlignedBoundingBox-8068b65c', './IntersectionTests-2f303a79', './Plane-d89efb5b'], (function (AttributeCompression, Matrix3, Color, defaultValue, IndexDatatype, Math$1, OrientedBoundingBox, Matrix2, createTaskProcessorWorker, ComponentDatatype, Check, WebGLConstants, Transforms, combine, RuntimeError, EllipsoidTangentPlane, AxisAlignedBoundingBox, IntersectionTests, Plane) { 'use strict';
